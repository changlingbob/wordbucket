...
describe('barrel file', function () {
    it('has well typed exports', function () {
        var hex = WordManager.create('hex');
        hex.add('test1', 1);
        hex.add('test2', 1);
        WordManager.create('hex.subtable');
        var subtable = WordManager.fetch('hex.subtable');
