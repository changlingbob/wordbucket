...
describe('deserialise', () => {
    it('basically deserialises', () => {
        expect(() => WordManager.deserialise('{"good-bucket": {"words":[{"words":"word1", "weight":1}, {"words":"word2", "weight":2}]}}')).not.toThrow(DeserialiseBucketError);
...
describe('serialise', () => {
    it('serialises one bucket', () => {
        ...
        test.add('word');
        expect(WordManager.serialise()).toBe('{"test":{"words":[{"words":"word","weight":1}],"title":"test"}}');
    });
});
